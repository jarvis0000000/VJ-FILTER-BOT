...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002273222930').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002420655950')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Damon00:Jarvis1234@cluster0.bjs5n.mongodb.net/")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Damon00")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Damoncollection')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://s3-eu-west-1.amazonaws.com/flowxo-images/images/3c3bda8b-2afc-4174-b91b-66141560d60c') # payment code picture url.
...
SUPPORT_CHAT = environ.get('') # Support Chat Link Without https:// or @
